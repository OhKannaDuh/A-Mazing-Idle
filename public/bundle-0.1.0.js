...
var MazeManager = exports.MazeManager = function () {
    ...
    _createClass(MazeManager, [{
        ...
        key: "spawnSplitBot",
        value: function spawnSplitBot(playerId, dirArr, isUnlimitedSplit) {
    ...
    _createClass(RNGBotManager, [{
        ...
        value: function chooseRandomDirectionsArr(playerId) {
            ...
            if (possibleNewSplits >= 1 && unvisitedDirs.length >= 2) {
                ...
                this.game.stats.addStatsToKey(numDirectionsToPick - 1, _Stats.StatsKey.TOTAL_NUMBER_OF_BOT_SPLITS);
...
var PointsHistoryTracker = exports.PointsHistoryTracker = function () {
    ...
    _createClass(PointsHistoryTracker, [{
        ...
        value: function getNextIndex() {
            return this.currIndex + 1 === this.slidingWindow.length ? 0 : this.currIndex + 1;
        }
    }, {
...
var Upgrade = function () {
    ...
    _createClass(Upgrade, [{
        ...
        value: function initUiButton() {
            ...
            var buttonTextId = this.uiId + BUTTON_TEXT_UI_ID_SUFFIX;
            var tooltipId = this.uiId + TOOLTIP_UI_ID_SUFFIX;
            var tooltipHtml = '<span id=\'' + tooltipId + '\' class=\'tooltip\'>' + this.tooltipText + '</span>';
            var textHtml = '<div id=\'' + buttonTextId + '\' class=\'button_label\'></div>';
            $('#' + this.uiId).html('' + textHtml + tooltipHtml);
        }
    }, {
        key: 'updateVisibility',
        value: function updateVisibility() {
            _UserInterface.UserInterface.setIdVisible(this.uiId, this.isUnlocked() && !this.isMaxUpgradeLevel() || _devUtils.DEBUG_ALL_BUTTONS_VISIBLE);
        }
    }, {
        ...
        value: function isAllPrerequisiteUpgradesComplete() {
            ...
            return prereqUpgradeKeys.every(function (key) {
                return _this3.game.upgrades.isUpgraded(key);
            });
        }
    }, {
