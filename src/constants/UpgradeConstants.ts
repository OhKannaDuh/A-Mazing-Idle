...
export enum UpgradeKey {
  ...
  MULTIPLIER_ITEM_EXTRA_BOT = 'MULTIPLIER_ITEM_EXTRA_BOT',
  UNLIMITED_SPLIT_ITEM_EXTRA_BOT = 'UNLIMITED_SPLIT_ITEM_EXTRA_BOT',
  // "Feature" Upgrades
...
export const UNLIMITED_SPLIT_ITEM_EXTRA_BOT_UPGRADE_BASE_COST = 5000;
export const UNLIMITED_SPLIT_ITEM_EXTRA_BOT_UPGRADE_BASE_COST_MULTIPLIER = 1;

export const MULTIPLIER_ITEM_EXTRA_BOT_UPGRADE_BASE_COST = 5000;
export const MULTIPLIER_ITEM_EXTRA_BOT_UPGRADE_BASE_COST_MULTIPLIER = 1;
...
export const BIOME_0_UPGRADE_COST = 750;
export const BIOME_1_UPGRADE_COST = 2500;
export const BIOME_2_UPGRADE_COST = 5000;
export const BIOME_3_UPGRADE_COST = 15000;
export const BIOME_4_UPGRADE_COST = 50000;
export const BIOME_5_UPGRADE_COST = 100000;
export const BIOME_6_UPGRADE_COST = 1000000;
