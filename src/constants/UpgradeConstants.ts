...
export const BIOME_7_UPGRADE_COST = 25000;
export const BIOME_8_UPGRADE_COST = 40000;

export const BIOME_UPGRADE_SCALING_START_LEVEL = 9;
export const BIOME_UPGRADE_BASE_COST = 40000;
