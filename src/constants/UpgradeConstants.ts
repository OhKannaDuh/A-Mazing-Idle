...
export const POINTS_PER_VISIT_BASE_AMOUNT_BIOME_1 = 2;
export const POINTS_PER_VISIT_BASE_AMOUNT_BIOME_2 = 3;
export const POINTS_PER_VISIT_BASE_AMOUNT_BIOME_3 = 4;

export const BIOME_0_PURCHASE_COST = 1e4;
export const BIOME_1_PURCHASE_COST = 1e6;
export const BIOME_2_PURCHASE_COST = 1e8;
export const BIOME_3_PURCHASE_COST = 1e10;
