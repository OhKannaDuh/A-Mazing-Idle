...
const TOOLTIP_TEXT = `When bot is faced with a choice of direction, the bot will be lucky in guessing direction by an extra ${BOT_LUCKY_GUESS_UPGRADE_INCREASE_AMOUNT}% (ie. 51%/49% of choosing correct direction at level 1).`;
