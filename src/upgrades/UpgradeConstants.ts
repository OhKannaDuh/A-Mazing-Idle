...
export const POINTS_PER_VISIT_BASE_AMOUNT_MULTIPLIER = 1.04;

export const FRUIT_SPAWN_UPGRADE_BASE_COST = 40;
export const FRUIT_SPAWN_UPGRADE_BASE_COST_MULTIPLIER = 1.3;
export const FRUIT_PICKUP_POINTS_UPGRADE_BASE_COST = 40;
